...
function AdminNavbar({current}) {
    ...
    const getNavItemClass = (path) => {
        return current === path ? "block py-2 px-4 rounded bg-yellow text-black transition duration-300" : "block py-2 px-4 rounded hover:text-yellow transition duration-300";
    }
    ...
    return (
        <nav className="bg-black text-white w-1/5 flex flex-col justify-between p-4">
            ...
            <ul className="flex-1 space-y-4 text-xl">
                <li>
                    <Link to="/admin/dashboard" className={getNavItemClass('Dashboard')}>Dashboard</Link>
                </li>
                <li>
                    <Link to="/admin/attendance" className={getNavItemClass("Attendance")}>Attendance</Link>
                </li>
                <li>
                    <Link to="/admin/leaves" className={getNavItemClass("Leaves")}>Leaves</Link>
                </li>
                <li>
                    <Link to="/admin/feedback" className={getNavItemClass("Feedback")}>Feedback</Link>
                </li>
                <li>
                    <Link to="/admin/tasks" className={getNavItemClass("Tasks")}>Tasks</Link>
                </li>
                <li>
                    <Link to="/admin/profile" className={getNavItemClass("Profile")}>Profile</Link>
                </li>
            </ul>
